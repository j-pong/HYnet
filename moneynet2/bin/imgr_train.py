...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument(
        ...
        default=0,
        type=int,
        help="The number of CPUs used in Dataloader Class"
    )
    parser.add_argument(
        "--pin-memory", default=False, type=bool,
        help="Option used in Dataloader Class"
    )
    parser.add_argument(
        "--train-dtype",
        default="float32",
    ...
    parser.add_argument(
        "--indir", default="/home/Workspace/DB/sinedataset/crop_resize", type=str)
    parser.add_argument(
        "--outdir", default="/home/Workspace/barofm/resutls",
    ...
    parser.add_argument(
        "--model-module",
        type=str,
        default="barofm.models.e2e_defect:NetTransform",
    ...
    parser.add_argument(
        "--eval-batch-size", default=1, type=int)
    parser.add_argument(
        "--batch-bins",
        default=0,
        type=int,
...
def main(cmd_args):
    ...
    from barofm.utils.dynamic_import import dynamic_import
    ...
    from barofm.defect.defect import train
    train(args)
