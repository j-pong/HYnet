...
@register_model("wav2vec_uda", dataclass=Wav2Vec2CtcConfig)
class Wav2VecUDA(BaseFairseqModel):
    ...
    def build_model(cls, cfg: Wav2Vec2CtcConfig, task: FairseqTask):
        ...
        w2v_encoder = Wav2VecUdaEncoder(cfg, len(task.target_dictionary))
...
class Wav2VecUdaEncoder(FairseqEncoder):
    ...
    def forward(self, source, padding_mask, mode, proj=True, tbc=True, **kwargs):
        w2v_args = {
            "source": source,
