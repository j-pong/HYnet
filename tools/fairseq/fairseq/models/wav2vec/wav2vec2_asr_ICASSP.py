...
from fairseq.models.wav2vec.wav2vec2 import MASKING_DISTRIBUTION_CHOICES, TransformerSentenceEncoderLayer
...
class Wav2VecEncoder(FairseqEncoder):
    def __init__(self, cfg: Wav2Vec2AsrConfig, output_size=None):
        ...
        self.w2v_args_model = w2v_args.model
    ...
    def forward(self, source, padding_mask, tbc=True, **kwargs):
        ...
        with torch.no_grad() if not ft else contextlib.ExitStack():
            res = self.w2v_model.extract_features(w2v_args["source"], w2v_args["padding_mask"],
                                                  w2v_args["mask"])
