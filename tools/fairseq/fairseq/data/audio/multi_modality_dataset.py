...
class MultiModalityDataset(ConcatDataset):
    ...
    def get_batch_samplers(self, mult_ratios, required_batch_size_multiple, seed, max_tokens, max_sentences, max_positions):
        self.max_tokens, self.max_sentences, self.max_positions = (max_tokens, max_sentences, max_positions)
