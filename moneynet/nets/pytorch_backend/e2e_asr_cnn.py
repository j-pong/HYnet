...
from moneynet.nets.pytorch_backend.cnn.encoders import encoder_for
...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def encoder_add_arguments(parser):
        ...
        group.add_argument(
            "--dropout-rate", default=None, type=float, help="dropout in cnn layers. use --dropout-rate if None is set"
        )
        group.add_argument(
