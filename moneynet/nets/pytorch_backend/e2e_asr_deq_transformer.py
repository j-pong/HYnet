...
from moneynet.nets.pytorch_backend.DEQ.transformer_encoder import Encoder
...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def forward(self, xs_pad, ilens, ys_pad):
        ...
        hs_pad = self.encoder(xs_pad, src_mask)
    ...
    def calculate_all_attentions(self, xs_pad, ilens, ys_pad):
        ...
        for name, m in self.named_modules():
            if isinstance(m, MultiHeadedAttention) and "copy" not in name:
