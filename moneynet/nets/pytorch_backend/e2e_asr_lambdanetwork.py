...
from moneynet.nets.pytorch_backend.lambdanet.encoders import Encoder
...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def calculate_λc(self, xs_pad, ilens, ys_pad):
        ...
        for name, m in self.named_modules():
            if isinstance(m, EncoderLayer):
                ret[name] = m.λc.cpu().numpy()
        return ret
