...
def load_trained_multi_target_model(model_path):
    """Load the trained model for recognition.
    ...
    if hasattr(train_args, "model_module"):
        ...
        model_module = "espnet.nets.pytorch_backend.e2e_asr:E2E"
    model_class = dynamic_import(model_module)
    model = model_class(idim, odim, odim, train_args)
...
def load_trained_multi_target_modules(idim, odim, mono_odim, args, interface=ASRInterface):
    ...
    main_model = model_class(idim, odim, mono_odim, args)
