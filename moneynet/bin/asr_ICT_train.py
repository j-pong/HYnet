...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument(
        ...
        default="adadelta",
        type=str,
        choices=["adadelta", "adam", "noam", "rmsprop", "sgd"],
        help="Optimizer",
    )
    parser.add_argument(
    ...
    parser.add_argument("--ema-post-decay", type=float, default=0.999,
                        help="ema decay parameter after consistency rampup ends")

    # others
    parser.add_argument("--show-student-model-acc", type=strtobool, default=False,
                        help="print out student model accuracy log if True")
    return parser
