...
python $PWD/../../../tools/fairseq/examples/wav2vec/libri_labels.py $save_ul_data_dir/train.tsv --output-dir $save_ul_data_dir --output-name $split
...
for dset in test_clean test_other dev_clean dev_other; do
    ...
    cp -r $save_test_data_dir/* $save_ul_data_dir
done
