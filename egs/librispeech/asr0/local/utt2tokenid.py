...
if __name__ == '__main__':
    ...
    with open(tokenid_scp, 'w') as tokenid:
        for key, array in read_vec_int_ark("gunzip -c " + os.path.join(args.ali_dir, 'ali.*.gz') + " | ali-to-pdf " + args.ali_mdl + " ark:- ark:-|"):
            lab_dict[key] = array
    ...
    text_path = os.path.join(args.data_dir, 'text_org')
    scp_path = args.fea_scp
    utt2spk_path = os.path.join(args.data_dir + 'utt2spk_org')
