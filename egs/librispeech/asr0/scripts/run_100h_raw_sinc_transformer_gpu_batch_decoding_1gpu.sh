...
train_dev=dev_raw
recog_set="test_clean_raw test_other_raw dev_clean_raw dev_other_raw"
...
if [ ${stage} -le 11 ] && [ ${stop_stage} -ge 11 ]; then
    ...
    utils/combine_data.sh --extra_files 'utt2num_frames tokenid.scp' data/${train_dev}_org data/dev_clean_raw data/dev_other_raw
